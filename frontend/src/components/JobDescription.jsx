    ...
    return (
        <div className='max-w-7xl mx-auto my-10'>
            ...
            <div className='my-4'>
                ...
                <h1 className='font-bold my-1'>Posted Date: <span className='pl-4 font-normal text-gray-800'>{singleJob?.createdAt ? new Date(singleJob.createdAt).toLocaleDateString("en-IN", { day: "2-digit", month: "short", year: "numeric" }) : "—"}</span></h1>
            </div>
        </div>
    )
}
