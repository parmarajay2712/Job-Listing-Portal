...
const Footer = () => {
  return (
    <footer className="border-t border-t-gray-200 py-6 md:py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">Job Listing Portal</h2>
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href="https://www.linkedin.com/in/ajayparmar27/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400" aria-label="LinkedIn">
